...
class Record:
    def __init__(self, name: Name, phone=None, birthday=None, email=None): 
        self.name = name
        self.email = email
        self.phones = []
        ...
        if phone:
            if type(phone) is Phone:                
                ...
                print('Error. phone must be an object of class Phone!')

        if birthday:
            if type(birthday) is Birthday:
                self.birthday = birthday
            else:
                print('Error, birthday must be an object of class Birthday!')
